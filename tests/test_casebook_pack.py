"""Regression checks for the raster-move-endgame-mark casebook."""
...
from casebook.harness import assert_expected, raster_move_endgame_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raster_move_endgame_mark_summary(), assert_expected())
