...
$repo = "raster-move-endgame-mark"
$language = "Elixir"
$category = "Chess and game engines"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/raster-move-endgame-walkthrough.md")) {
